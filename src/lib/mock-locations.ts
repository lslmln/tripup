...
export const mockLocations: Location[] = [
  ...
  { id: "l5", name: "Taberna", subtitle: "Tavern", emoji: "🍢" },
  { id: "l6", name: "Zambeze", subtitle: "Restaurant", emoji: "🍛" },
  { id: "l7", name: "Pistolas", subtitle: "Taqueria", emoji: "🌮" },
  { id: "l8", name: "Ramiro", subtitle: "Seafood", emoji: "🦐" },
  { id: "l9", name: "São Bento", subtitle: "Steakhouse", emoji: "🥩" },
